...
class BotDatabase:
	...
	def update_pair(self, bot, symbol, pair):
		"""
		Updates a Bot within the Database
		"""
	...
	def get_open_orders_of_bot(self, bot):
		"""
	...
	def get_active_pairs_of_bot(self, bot):
		"""
		Gets all the bots within a database
		"""
	...
	def get_all_pairs_of_bot(self, bot):
		"""
		Gets all the bots within a database
		"""
